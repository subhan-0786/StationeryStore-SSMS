<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Roles.aspx.vb" Inherits="Roles" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>System Roles - Stationery Store</title>
    <!-- Bootstrap CSS CDN -->
...
<body>
    <form id="form1" runat="server">
        <div class="container mt-3">
            ...
            <!-- Page Content -->
            <h2 class="header text-center mb-4">System Roles</h2>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <h3 class="header mb-3">Role List</h3>
